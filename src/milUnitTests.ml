...
let tests = [
  ...
  "mil_unit_apply_retreat_penalty_test1" >:: (fun _ ->
  ...
  "mil_unit_apply_retreat_penalty_test2" >:: (fun _ ->
  ...
  "mil_unit_apply_retreat_penalty_test3" >:: (fun _ ->
  ...
  "mil_unit_apply_retreat_penalty_test4" >:: (fun _ ->
